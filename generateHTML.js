//renders the html body for the webpage
...
//renders each team member card once the webpage has been made above
const renderCard = (teamMember) => {
    console.log("Creating member card...");
    let htmlText = `<!-- Team Member Card -->
    <div class="col">
